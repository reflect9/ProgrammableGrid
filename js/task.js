pg.task = {
    ...
    calculation2 : {
        json: {"id":"eWeeA","title":"Task - Calculation","active":true,"nodes":[{"I":["_above","_left"],"ID":"ZJxtq","P":{"kind":"flow","type":"trigger","icon":"bell","param":{"event_source":"page"},"description":"Trigger the following nodes when [event_source] is loaded, clicked, or changed."},"V":[],"selected":false,"position":[0,1],"type":"trigger","executed":false},{"I":["ZJxtq"],"ID":"10UcH","P":{"kind":"transform","type":"literal","icon":"quote-right","param":{"source":"[3,9,2]"},"description":"Directly set the current node data to [source]."},"V":[],"selected":false,"position":[1,2],"type":"literal","executed":true},{"I":["ZJxtq"],"ID":"tuORp","P":{"kind":"transform","type":"literal","icon":"quote-right","param":{"source":"[1,2,6]"},"description":"Directly set the current node data to [source]."},"V":[],"selected":false,"position":[2,1],"type":"literal","executed":true},{"I":["ZJxtq","_left"],"ID":"2YOPq","P":{"kind":"transform","type":"literal","icon":"quote-right","param":{"source":"[3,2,7]"},"description":"Directly set the current node data to [source]."},"V":[],"selected":false,"position":[4,1],"type":"literal","executed":true},{"I":["ZJxtq","_left"],"ID":"KHYsj","P":{"kind":"transform","type":"literal","icon":"quote-right","param":{"source":"[8,16,12]"},"description":"Directly set the current node data to [source]."},"V":[],"selected":false,"position":[6,2],"type":"literal","executed":true},{"I":["ZJxtq","_left"],"ID":"IL7Ep","P":{"kind":"transform","type":"literal","icon":"quote-right","param":{"source":"[10,8,22,11]"},"description":"Directly set the current node data to [source]."},"V":[],"selected":false,"position":[9,1],"type":"literal","executed":true},{"I":["ZJxtq","_left"],"ID":"By5Zn","P":{"kind":"transform","type":"literal","icon":"quote-right","param":{"source":"[9,7,6]"},"description":"Directly set the current node data to [source]."},"V":[],"selected":false,"position":[11,2],"type":"literal","executed":true},{"I":["ZJxtq","_left"],"ID":"zRKia","P":{"kind":"transform","type":"literal","icon":"quote-right","param":{"source":"[1,1,2]"},"description":"Directly set the current node data to [source]."},"V":[],"selected":false,"position":[12,1],"type":"literal","executed":true}],"notes":[{"id":"note-URWyp","title":"Problem 1 of 5","description":"Multiply every number in [3,9,2] with [1,2,6]. <br> => The result should be [3,18,12]","position":[2,3],"width":3,"height":1},{"id":"note-k9FyR","title":"Problem 2 of 5","description":"Arrange [3,2,7] in increasing order. <br> => The result should be [2,3,7]","position":[4,3],"width":3,"height":1},{"id":"note-ZknHV","title":"Problem 3 of 5","description":"Divide numbers [8,16,12] by 4. <br> => The result should be [2,4,3]","position":[7,3],"width":3,"height":1},{"id":"note-Lfth4","title":"Problem 4 of 5","description":"How many numbers are in [10,8,22,11]? <br> => The result should be [4]","position":[9,3],"width":3,"height":1},{"id":"note-nfLTy","title":"Problem 5 of 5","description":"Add every number in [9,7,6] with [1,1,2]. <br> => The result should be [10,8,8]","position":[12,3],"width":3,"height":1}],"domain":["http://takyeonlee.com/tandem-learn/practice1.html"],"timestamp":1409554669130},
        notes: [
    ...
    filter2 : {
       json: {"id":"rnibI","title":"Filter Tasks","active":true,"nodes":[{"I":["_above","_left"],"ID":"hbCYc","P":{"kind":"flow","type":"trigger","icon":"bell","param":{"event_source":"page"},"description":"Trigger the following nodes when [event_source] is loaded, clicked, or changed."},"V":[],"selected":false,"position":[0,1],"type":"trigger","executed":false},{"I":["hbCYc","_left"],"ID":"e9ZXh","P":{"kind":"transform","type":"literal","icon":"quote-right","param":{"source":"[1,2,3,4]"},"description":"Directly set the current node data to [source]."},"V":[],"selected":false,"position":[2,1],"type":"literal","executed":true},{"I":["hbCYc","_left"],"ID":"02PDg","P":{"kind":"transform","type":"literal","icon":"quote-right","param":{"source":"[\"apple juice\",\"banana\",\"apple\",\"peach\"]"},"description":"Directly set the current node data to [source]."},"V":[],"selected":false,"position":[5,1],"type":"literal","executed":true}],"notes":[{"id":"note-XsGca","title":"Problem 1 of 2","description":"Find odd numbers in the list <br> => The result should be [1,3]","position":[3,2],"width":3,"height":1},{"id":"note-ZTBMV","title":"Problem 2 of 2","description":"Find text values in the list that contains \"apple\" <br> => The result should be [\"apple juice\",\"apple\"]","position":[6,2],"width":3,"height":1}],"domain":["http://takyeonlee.com/tandem-learn/task.html?task=extraction1"],"timestamp":1409562653131},
        notes: [
