pg.task = {
    ...
    calculation2 : {
        ...
        notes: [
            ...
            {   description:"How many numbers are in [10,8,22,11]? <br> => The result should be [3]",
                position: [9,3],
                width:3
            },
    ...
    filter2 : {
       json: {"id":"rnibI","title":"Filter Tasks","active":true,"nodes":[{"I":["_above","_left"],"ID":"hbCYc","P":{"kind":"flow","type":"trigger","icon":"bell","param":{"event_source":"page"},"description":"Trigger the following nodes when [event_source] is loaded, clicked, or changed."},"V":[],"selected":false,"position":[0,1],"type":"trigger","executed":false},{"I":["hbCYc","_left"],"ID":"OR9xL","P":{"kind":"pick","type":"extract_element","icon":"crosshairs","param":{"source":"_current","selector":"> DIV.container-fluid > DIV.main > CENTER > TABLE.table.table-bordered > TBODY > TR"},"description":"Extract elements at [selector] from [source]."},"V":[],"selected":false,"position":[6,4],"type":"extract_element","executed":true},{"I":["hbCYc","_left"],"ID":"mEMY1","P":{"kind":"apply","type":"create_element","icon":"magic","param":{"value":"Search by use","tag":"text input"},"description":"Create [tag] elements using the [value].","applicable":false},"V":[],"selected":false,"position":[5,1],"executed":true},{"I":["_above","_left"],"ID":"VBRb1","P":{"kind":"pick","type":"extract_element","icon":"crosshairs","param":{"source":"_current","selector":"> DIV:nth-of-type(1) > DIV > CENTER > TABLE"},"description":"Extract elements at [selector] from [source]."},"V":[],"selected":false,"position":[6,1],"executed":true},{"I":["mEMY1","VBRb1"],"ID":"3HDkS","P":{"kind":"apply","type":"attach_element","icon":"gavel","param":{"source":"input1","target":"input2","location":"after"},"description":"Attach [source] to [target] at [location]."},"V":[],"selected":false,"position":[6,2],"executed":true},{"I":["_above","_left"],"ID":"PXdbS","P":{"kind":"flow","type":"trigger","icon":"bell","param":{"event_source":"input1"},"description":"Trigger the following nodes when [event_source] is loaded, clicked, or changed.","applicable":false},"V":[],"selected":false,"position":[7,2],"executed":false},{"I":["_above","_left"],"ID":"qeiVc","P":{"kind":"pick","icon":"list-alt","type":"get_attribute","param":{"source":"input1","key":"value"},"description":"Get [key] of [source].","applicable":false},"V":[],"selected":false,"position":[8,2],"executed":false},{"I":["hbCYc","_left"],"ID":"e9ZXh","P":{"kind":"transform","type":"literal","icon":"quote-right","param":{"source":"[1,2,3,4]"},"description":"Directly set the current node data to [source]."},"V":[],"selected":false,"position":[2,1],"type":"literal","executed":true},{"I":["hbCYc","_left"],"ID":"mGJY0","P":{"kind":"transform","type":"literal","icon":"quote-right","param":{"source":"[5,13,11,7]"},"description":"Directly set the current node data to [source]."},"V":[],"selected":false,"position":[10,1],"type":"literal","executed":true},{"I":["hbCYc","_left"],"ID":"a8ewz","P":{"kind":"pick","type":"extract_element","icon":"crosshairs","param":{"source":"_current","selector":"> DIV.container-fluid > DIV.main > CENTER > TABLE.table.table-bordered > TBODY > TR"},"description":"Extract elements at [selector] from [source]."},"V":[],"selected":false,"position":[13,1],"type":"extract_element","executed":true}],"notes":[{"id":"note-iJ1NF","title":"Problem 1 of 4","description":"Find odd numbers in the list <br> => The result should be [1,3]","position":[3,1],"width":3,"height":1},{"id":"note-O6rYj","title":"Problem 2 of 4","description":"Find rows(TR) whose usage match with the text in the input box.  For example, if 'Cider' is typed in the box, the result should be[TR: Musca...]","position":[6,2],"width":3,"height":1},{"id":"note-BY5eJ","title":"Problem 3 of 4","description":"Find text values in the list that contains \"banana\" <br> => The result should be [\"banana\"]","position":[10,1],"width":3,"height":1},{"id":"note-Uh6f1","title":"Problem 4 of 4","description":"Find rows(TR) whose origin is US <br> => The result should be [TR: Beacon.., TR:Wealthy...]","position":[16,4],"width":3,"height":1}],"domain":["http://takyeonlee.com/tandem-learn/task.html?task=extraction1"],"timestamp":1409562653131},
        notes: [
            ...
            {   description:"Find rows(TR) whose origin is US <br> => The result should be [TR: Beacon.., TR:Wealthy...]",
                position: [14,1],
                width:3
            }
    ...
    attach2 : {
        ...
        notes: [
            ...
            {   description:'Attach the CHECKBOX element in the above node to front of every apple name (Anna, Ariane, ...)',
                position: [7,2],
                width:3
            },
        ]
